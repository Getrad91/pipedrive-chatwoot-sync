...
def main():
    ...
    try:
        with conn.cursor(pymysql.cursors.DictCursor) as cursor:
            ...
            progress_reporter = ProgressReporter(len(contacts), logger, "Syncing Common Support Links")
            ...
            if progress_reporter.successful > 0:
                ...
                logger.info("Check the Chatwoot interface for the updated Common Support fields.")
