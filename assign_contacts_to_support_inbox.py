...
def main():
    ...
    try:
        with conn.cursor(pymysql.cursors.DictCursor) as cursor:
            ...
            progress_reporter = ProgressReporter(len(contacts), logger, "Assigning contacts to inbox")
            ...
            if progress_reporter.successful > 0:
                logger.info(f"🔍 Check the contacts at: {CHATWOOT_BASE_URL.replace('/api/v1/accounts/2', '/app/accounts/2/contacts')}")
